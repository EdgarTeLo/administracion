...
<body>
    ...
    <main class="container mt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="<?php echo $_ENV['APP_URL']; ?>/facturas/crear" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="fact" id="fact" class="form-control" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="orden_compra" id="orden_compra" class="form-select">
                            ...
                            <?php foreach ($ordenes as $orden): ?>
                                <option value="<?php echo htmlspecialchars($orden['numero_oc']); ?>">
